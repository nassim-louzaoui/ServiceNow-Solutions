...
TEMPLATES = [
    ...
    ("Operations Intelligence - Creator Assist Token Expired", PERSON,
     "Your creator assist token requires attention",
     "Your creator assist integration token could not be validated. Please reconnect it in Operations Studio to restore specification assistance."),
