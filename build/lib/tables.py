...
TABLES = [
    ("person", "Operator Profile", [
        ...
        ("spec_assist_enabled",     "bool",          "Specification Assist Enabled",  {"default": "false"}),
    ...
    ("use_case_request", "Build Request", [
        ...
        ("status",                   "choice",        "Status",                      {"max_length": 40}),
        ("spec_assist_enhanced",     "bool",          "Specification Assist Enhanced", {"default": "false"}),
        ("assist_phrases_applied",   "bool",          "Assist Phrases Applied",       {"default": "false"}),
        ("submitted_at",             "dt",            "Submitted At",                {}),
    ...
    ("managed_artifact", "Managed Deliverable", [
        ...
        ("spec_assist_used",     "bool",           "Specification Assist Used",    {"default": "false"}),
        ("spec_assist_applied",  "bool",           "Specification Assist Applied", {"default": "false"}),
        ("created_at",           "dt",             "Created At",       {}),
